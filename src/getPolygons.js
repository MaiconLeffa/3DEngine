...
export default (edges, vertices, size, translateX, translateY, translateZ) => {
  const polygons = []
  ...
  edges.forEach(point => {
    ...
    const p1 = [
      ...
      (parseFloat(vertices[point[0]][2]) * size) + translateZ
    ]
    ...
    const p2 = [
      ...
      (parseFloat(vertices[point[1]][2]) * size) + translateZ
    ]
    ...
    const p3 = [
      ...
      (parseFloat(vertices[point[2]][2]) * size) + translateZ
    ]
    ...
    if (point[3]) {
      ...
      const p4 = [
        ...
        (parseFloat(vertices[point[3]][2]) * size) + translateZ
      ]
